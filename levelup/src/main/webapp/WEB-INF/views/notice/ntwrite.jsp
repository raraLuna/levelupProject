	...
	<div class="main-content">
		<div class="page-content">
			<div class="container-fluid">
				...
				<!-- 여기서부터 내용 작성 -->
				<h1 align="left">새 팀 공지글 등록 페이지</h1>
							...
							<div class="card">
								<div class="card-body">
									...
									<p class="card-title-desc">
										<tr>
											<th>작성자</th>
											<td>: <b>${sessionScope.loginEmployee.employeeName}</b><input type="hidden" name="employeeId" readonly
												value="${sessionScope.loginEmployee.employeeId}"></td>
										</tr>
										<br>
										<tr>
											<th>부서 선택</th>
									...
									<textarea id="elm1" name="noticeContent" class="form-control"
										rows="25" placeholder="Enter Your Message"></textarea>
